...
from starsrgan.utils.loss import build_loss
from starsrgan.utils.arch import build_network
from starsrgan.utils.logger import get_root_logger
from starsrgan.utils.metric import calculate_metric
from starsrgan.utils.img import imwrite, tensor2img
from starsrgan.utils.registry import MODEL_REGISTRY
from starsrgan.models.base_model import BaseModel


@MODEL_REGISTRY.register()
class StarNetModel(BaseModel):
    """Base SR model for single image super-resolution."""

    def __init__(self, opt):
        super(StarNetModel, self).__init__(opt)
